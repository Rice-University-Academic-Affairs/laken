...
@patch("laken.local_lakehouse.default_fabric_fetcher")
def test_local_lakehouse_resolves_default_fabric_fetcher_lazily(mock_default, tmp_path):
    fetcher = MagicMock()
...
def test_local_lakehouse_explicit_fetcher_skips_default(tmp_path):
    ...
    with patch("laken.local_lakehouse.default_fabric_fetcher") as mock_default:
